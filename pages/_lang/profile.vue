    ...
    <div class="pane-form">
      ...
      <div class="portfolio">
        ...
        <template v-if="assets.length !== 0">
          <div class="assets">
            <asset-item :asset="asset" :fixedNumber="4" :key="asset.assetId" @click="onClickAsset(asset)" v-for="asset in assets" width="48%"></asset-item>
          </div>
        </template>
        <template v-else>
      ...
      <button @click="onLogout" class="button alt">Sign out</button>
    </div>
  </div>
</template>
